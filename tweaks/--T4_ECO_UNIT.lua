      ...
      cloneIfMissing(
        ...
        legendaryConverterName,
        {
          ...
          customparams = {
            ...
            i18n_en_tooltip = 'Convert 12k energy to 264m/s by Jackie (No Explosion)'
          },
    ...
    if fusionBase then
      ...
      cloneIfMissing(
        ...
        legendaryFusionName,
        {
          ...
          description = 'Legendary Fusion Reactor by Jackie (No Explosion)',
          ...
          sfxtypes = {pieceexplosiongenerators = {[1] = 'deathceg2', [2] = 'deathceg3', [3] = 'deathceg4'}},
          sounds = {
...
do
  local UnitDefs, a = UnitDefs or {}, 'armbotrail'
  local b = {
    armt3 = {
      maxthisunit = 9999,
      footprintx = 6,
      ...
      customparams = {
        ...
        i18n_en_tooltip = 'Launches Titan, Thor & Ratte by Pyrem x9999 Max'
      },
      weapondefs = {
        arm_botrail = {
          stockpiletime = 8,
          ...
          reloadtime = 2,
          customparams = {stockpilelimit = 50, spawns_name = 'armbanth armthor armrattet4', spawns_mode = 'random'}
        }
      }
    },
    cort3 = {
      ...
      customparams = {
        ...
        i18n_en_tooltip = 'Launches Tzar, Behemoth & Juggernaut by Pyrem x9999 Max'
      },
      weapondefs = {
        arm_botrail = {
          stockpiletime = 8,
          ...
          energypershot = 180000,
          reloadtime = 2,
          customparams = {stockpilelimit = 50, spawns_name = 'corjugg corkorg corgolt4', spawns_mode = 'random'}
        }
      }
    },
    legt3 = {
      ...
      customparams = {
        ...
        i18n_en_tooltip = 'Launches Sols (2 Types) by Pyrem x9999 Max'
      },
      weapondefs = {
        arm_botrail = {
          stockpiletime = 8,
  ...
  if UnitDefs.cormandot4 then
    for c, d in pairs(b) do
      ...
      if UnitDefs[a] and not UnitDefs[e] then
        UnitDefs[e] = table.merge(UnitDefs[a], d)
