...
local function testResponseUsesApiMatchStatus()
	...
	assertTrue(string.find(view.challengeHelpText, 'absolute difficulty on a 0-34 scale', 1, true) ~= nil)
	assertTrue(string.find(view.challengeHelpText, 'Difficulty Percentile compares this score', 1, true) ~= nil)
	assertTrue(string.find(view.difficultyPercentileHelpText, 'relative placement, not the Challenge score itself', 1, true) ~= nil)
...
local function testClientVersionNoticeIsInformational()
	...
	assertEquals(newer.difficultyText, 'Unplaced')
end
...
local function testDifficultyEvidenceAndHiddenDiffDiagnostics()
	...
	assertEquals(population.difficultyText, 'Unplaced')
	...
	assertTrue(string.find(population.challengeHelpText, 'does not have a Challenge score yet', 1, true) ~= nil)
