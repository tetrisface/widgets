...
-- green = '\255\255\255\1'
-- red = '\255\255\255\1'
-- yellow = '\255\255\255\1'
-- orange = '\255\255\255\1'
-- blue = '\255\255\255\1'

-- metalColor = '\255\255\255\1'
-- energyColor = '\255\255\255\1'
-- buildColor = '\255\255\255\1'
...
function widget:DrawScreen()
  ...
  local energyUpkeepMake = 0
  if uDef.energyUpkeep < 0 then
    energyUpkeepMake = -uDef.energyUpkeep
  else
    energyUpkeepMake = uDef.energyMake
  end
