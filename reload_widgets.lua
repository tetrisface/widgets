...
function widget:KeyPress(key, mods, isRepeat)
  ...
  if (key == KEYSYMS.R and mods['ctrl']) then
    ...
    Spring.SendCommands('disablewidget Shield Ground Rings GL4')
    Spring.SendCommands('enablewidget Shield Ground Rings GL4')
    ...
    -- Spring.SendCommands("disablewidget Shield Ground Rings chatgpt")
    -- Spring.SendCommands("enablewidget Shield Ground Rings chatgpt")
    return false
  end
